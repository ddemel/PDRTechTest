...
namespace PDR.PatientBooking.Service.DoctorServices.Validation
{
    public class AddDoctorRequestValidator : IAddDoctorRequestValidator
    {
        ...
        private bool EmailIsInvalid(AddDoctorRequest request, ref PdrValidationResult result)
        {
            EmailAddressValidation emailAddressValidation = new EmailAddressValidation();
            emailAddressValidation.Email = request.Email;
